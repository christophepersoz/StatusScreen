...
PLATFORM_TAG      = EMBEDXCODE=$(RELEASE_NOW) ARDUINO=10608 SIMBLEE __PROJECT__='"$(PROJECT_NAME_AS_IDENTIFIER).$(SKETCH_EXTENSION)"'
...
ifeq ($(USER_LIBRARY_DIR)/Arduino15/preferences.txt,)
    $(error Error: run SIMBLEE once and define the sketchbook path)
endif
...
EXTRA_CPPFLAGS += $(addprefix -I$(HARDWARE_PATH)/, variants/Simblee system/Simblee system/Simblee/include system/CMSIS/CMSIS/Include)
