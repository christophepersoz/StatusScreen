...
# Arducam ESP8266 specifics
# ----------------------------------
#
PLATFORM         := ArduCAM
PLATFORM_TAG      = ARDUINO=10608 ARDUINO_ARCH_ARDUCAM_ESP8266_UNO EMBEDXCODE=$(RELEASE_NOW) ESP8266
...
ESP_POST_COMPILE   = $(APPLICATION_PATH)/tools/esptool/$(ARDUCAM_ESP_TOOLS_RELEASE)/esptool
...
# ~~
    ...
    UPLOADER            = esptool
    UPLOADER_PATH       = $(OTHER_TOOLS_PATH)/esptool/$(ARDUCAM_ESP_TOOLS_RELEASE)
...
#    BOARD_TAG      := generic
    L_FLAGS         = -lm -lgcc -lhal -lphy -lnet80211 -llwip -lwpa -lmain -lpp -lsmartconfig -lwps -lcrypto -laxtls -lmesh -lwpa2
    ADDRESS_BIN1     = 00000
#    ADDRESS_BIN2    = 40000
#else
# For ESP8266 1.6.1
